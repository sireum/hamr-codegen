...
object LongKeys {
  ...
  // org.sireum.IS<org.sireum.Z, org.sireum.String> knownKeys = org.sireum.IS$.MODULE$.apply(iseq, org.sireum.Z$.MODULE$).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.msgpack())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.verbose())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.runtimeMonitoring())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.platform())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.outputDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.parseableMessages())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_slangOutputDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_packageName())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_noProyekIve())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_noEmbedArt())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_devicesAsThreads())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Slang_genSbtMill())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_slangAuxCodeDirs())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_slangOutputCDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_excludeComponentImpl())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_bitWidth())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_maxStringSize())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_maxArraySize())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Transpiler_runTranspiler())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_scheduling())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_verusAttributeSyntax())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_sel4OutputDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_sel4AuxCodeDirs())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_workspaceRootDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_strictAadlMode())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_ros2OutputWorkspaceDir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_ros2Dir())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_ros2NodesLanguage())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_ros2LaunchLanguage())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.ROS2_invertTopicBinding())).$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.Experimental_experimentalOptions()));
