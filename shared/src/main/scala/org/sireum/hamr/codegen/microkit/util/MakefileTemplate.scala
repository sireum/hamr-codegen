  ...
  @pure def systemMakefileDomainScheduler(elfFiles: ISZ[String],
    ...
    val content =
      st"""${CommentTemplate.doNotEditComment_hash}
          ...
          |${TAB}xmllint --xinclude $$(TOP_DIR)/$$(MSD) | awk 'FNR==1{print; print "<!--"; print "  DO NOT EDIT: This file is generated by merging"; print "    $$(TOP_DIR)/$$(MSD)"; print "  and its xi:included files."; print "  Modify the source files and run make instead."; print "-->"; next}1' > $$(TOP_BUILD_DIR)/$$(MSD).merged
  ...
  @pure def systemMakefileMCS(elfFiles: ISZ[String],
    ...
    val content =
      st"""${CommentTemplate.doNotEditComment_hash}
          ...
          |${TAB}$$(PYTHON) $$(MSD) --sddf $$(SDDF) --board $$(MICROKIT_BOARD) --dtb $$(DTB) --output . --sdf $$(SYSTEM_FILE) --objcopy $$(OBJCOPY) --tests "$$(TESTS)"
